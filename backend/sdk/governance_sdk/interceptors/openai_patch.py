"""Auto-instrumentation for openai.chat.completions.create.

Each call automatically:
  - Reads the model name from kwargs (always known at call time)
  - Reads prompt/completion token counts from response.usage
...
def patch(sdk: "GovernanceSDK") -> None:
    ...
    _original = openai.chat.completions.create
    ...
    openai.chat.completions.create = _patched
