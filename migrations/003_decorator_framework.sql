...
-- ============================================================
-- Links each model call to the decorated function that triggered it
-- and tracks call order within a multi-model pipeline execution.
...
-- Auto-registry: every decorated function is recorded here on
-- first invocation. Powers the tool inventory dashboard.
-- ============================================================
...
-- Expression-based unique index — handles NULL module_path correctly.
...
-- Built by the daily-aggregation worker; queried by the
-- project-level governance dashboard for model tracking.
-- ============================================================
...
-- Expression-based unique index — COALESCE handles nullable project_id.
...
-- Upserted on each call; used for tool-level audit and monitoring.
-- ============================================================
...
-- Enabled by capture_io=True on the decorator (default: on).
-- Input/output text is PII-masked before storage.
-- ============================================================
...
-- ============================================================
-- Done. Verify new tables:
--   SELECT table_name FROM information_schema.tables
--   WHERE table_schema = 'public'
--   AND table_name IN (
--     'decorator_registrations', 'project_model_usage',
